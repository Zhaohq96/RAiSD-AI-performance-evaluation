...
show_help() {
    ...
    echo "sh run_diploSHIC.sh train Example_dataset/train/neutral.ms Example_dataset/train/selsweep.ms Example_result/ 128 100000 100"
    echo "sh run_diploSHIC.sh test Example_dataset/test/neutral.ms Example_dataset/test/selsweep.ms Example_result/ Example_result/train/model/ 128 100000"
}
...
if [ "$1" = "train" ]; then
	...
	sh ./SCRIPTS/diploSHIC_scripts/diploSHIC_training.sh "$4""$1"/extracted_data/neutral.ms "$4""$1"/extracted_data/selsweep.ms "$4""$1"/model $7;
...
# Test
	...
	mkdir -p "$4""$1"/result;
	mkdir -p "$4""$1"/extracted_data;
	./convert -i $2 -m original -c bp -w $6 -s 5000 -l $7 -r 5 -g 1 -o "$4""$1"/extracted_data/neutral.ms
	./convert -i $3 -m original -c bp -w $6 -s 5000 -l $7 -r 5 -g 1 -o "$4""$1"/extracted_data/selsweep.ms
